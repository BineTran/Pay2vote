...
//     {
//         "reference": "947S2361BGUHXD8G",
//         "bookingDate": "",
//         "transactionDate": "2023-06-28",
//         "transactionDateTime": "2023-06-28 22:46:03",
//         "amount": 20000,
//         "description": "CT DEN:317915347579 CASV99CASV RAT HAM MO EM",
//         "runningBalance": 110000,
//         "accountNumber": "100879072980",
//         "virtualAccountNumber": "",
//         "virtualAccountName": "",
//         "paymentChannel": "28 - Transware (TWO) Switch via Banknet VPG (VTB Payment Gateway)",
//         "counterAccountNumber": "0004100033739008",
//         "counterAccountName": "NGUYEN QUOC NHUT",
//         "counterAccountBankId": "970448",
//         "counterAccountBankName": "OCB_NHTMCP Phuong Dong"
//     },
//     {
//         "reference": "947S2361BGNMLBBN",
//         "bookingDate": "",
//         "transactionDate": "2023-06-28",
//         "transactionDateTime": "2023-06-28 22:41:36",
//         "amount": 20000,
//         "description": "CT DEN:317915346782 CASV7CASV Iu nhom qua",
...
//     },
//     {
//         "reference": "947S2361BGM9XJ15",
//         "bookingDate": "",
//         "transactionDate": "2023-06-28",
//         "transactionDateTime": "2023-06-28 22:40:35",
//         "amount": 20000,
//         "description": "CT DEN:317915346566 CASV0008CASV Ham mo em",
...
//     },
//     {
//         "reference": "947S2361BGJLJ3BF",
//         "bookingDate": "",
//         "transactionDate": "2023-06-28",
//         "transactionDateTime": "2023-06-28 22:38:32",
//         "amount": 20000,
//         "description": "CT DEN:317915346197 CASV07CASV",
...
//     },
//     {
//         "reference": "947S2361BEP016F7",
//         "bookingDate": "",
//         "transactionDate": "2023-06-28",
//         "transactionDateTime": "2023-06-28 21:50:23",
//         "amount": 20000,
//         "description": "CT DEN:317914335903 CASV06CASV Hung dep trai",
...
//     },
//     {
//         "reference": "rcjy-7jHb7wPEi",
//         "bookingDate": "",
//         "transactionDate": "2023-06-27",
//         "transactionDateTime": "2023-06-27 15:03:34",
//         "amount": -10000,
//         "description": "NGUYEN DUY HUNG Chuyen tien",
//         "runningBalance": 10000,
//         "accountNumber": "100879072980",
//         "virtualAccountNumber": "",
//         "virtualAccountName": "",
//         "paymentChannel": "78 - Retail Internet Banking",
//         "counterAccountNumber": "105879076038",
//         "counterAccountName": "TRAN LONG BIEN",
//         "counterAccountBankId": "970415",
//         "counterAccountBankName": "VietinBank"
//     },
//     {
//         "reference": "1gDhm-7jHayZH8y",
//         "bookingDate": "",
//         "transactionDate": "2023-06-27",
//         "transactionDateTime": "2023-06-27 15:01:16",
//         "amount": 10000,
//         "description": "TRAN LONG BIEN Chuyen tien",
...
//     },
//     {
//         "reference": "947S236199D71WPP",
//         "bookingDate": "",
//         "transactionDate": "2023-06-27",
//         "transactionDateTime": "2023-06-27 14:23:27",
//         "amount": 10000,
//         "description": "CT DEN:317807822024 2bdvsvv",
//         "runningBalance": 10000,
//         "accountNumber": "100879072980",
//         "virtualAccountNumber": "",
//         "virtualAccountName": "",
//         "paymentChannel": "28 - Transware (TWO) Switch via Banknet VPG (VTB Payment Gateway)",
//         "counterAccountNumber": "0697044102899",
//         "counterAccountName": "MOMOIBFT",
//         "counterAccountBankId": "970454",
//         "counterAccountBankName": "BanVietBank_NHTMCP Ban Viet"
//     }
// ]

import { processBIN } from './TransactionService';
...
export const transactionDB = [
	{
		transaction_datetime: '2023-08-04T03:15:00.000Z',
		reference: 'FT23216XY5Q5\\BNK',
...
describe('Transaction service test', () => {
	it('should return a BIN when it is a correct BIN', () => {
		const bankId = '970436';
		const expectedBankId = '970436';
		const result = processBIN(bankId, banks);

		expect(result).toBe(expectedBankId);
	});

	it('should return a BIN when it is a new BIN but exist in convert table', () => {
		const bankId = '888899';
		const expectedBankId = '970407';
		const result = processBIN(bankId, banks);
	...
	it('should return a BIN when it is a new BIN but exist in convert table', () => {
		const bankId = '970488';
		const expectedBankId = '970418';
		const result = processBIN(bankId, banks);

		expect(result).toBe(expectedBankId);
	});

	it('should return a BIN when it is a swift code', () => {
		const bankId = 'BFTVVNVX';
		const expectedBankId = '970436';
		const result = processBIN(bankId, banks);
	...
	it('should return a BIN when nothing is found, then rely to refund service to reject it', () => {
		const bankId = '6969';
		const expectedBankId = '6969';
		const result = processBIN(bankId, banks);
